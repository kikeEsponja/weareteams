...
<body>
    <center>
        <h1 class="h1">Ingreso Profesores</h1>
        <form action="../src/js/log_login_prof.php" method="POST">
        ...
        <br>
        <div>
            <label for="ir_a_registro_profesores">No tiene cuenta? regístrese -></label>
    ...
    <script>
        const registroAlum = document.getElementById('ir_a_registro_profesores');
        ...
        olvido.addEventListener('click', ()=>{
            window.location.href = './olvido_prof.php';
        });
    </script>
